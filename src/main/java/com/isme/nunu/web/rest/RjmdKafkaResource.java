...
import com.isme.nunu.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/rjmd-kafka")
public class RjmdKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RjmdKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public RjmdKafkaResource(KafkaProperties kafkaProperties) {
